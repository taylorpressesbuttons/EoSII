                ...
                bool storage)
{
     ...
     */
    if (ch->level < obj->level || obj->item_type == ITEM_KEY || obj->deleted)
        return;
...
bool load_char_obj(DESCRIPTOR_DATA *d, char *name)
{
    ...
    *ch->pcdata = pcdata_zero;
    ...
    ch->act = PLR_BLANK | PLR_COMBINE | PLR_PROMPT | PLR_ANSI | PLR_COMBAT;
		 ...
		 * -- Altrag                                      */
		  ...
		  ch->trust = 0;*/
            ...
            case 'H':
                ...
                break;
            case 'I':
                KEY("Ignr", ch->pcdata->ignoring, fread_string(fp));
        ...
        switch (UPPER(word[0]))
        {
		    ...
		    obj_free  = obj;*/
                    ...
                    else
                    {
                        ...
                        if (obj->item_type == ITEM_NOTEBOARD || obj->item_type == ITEM_PORTAL)
                            extract_obj(obj);
                        return;
                    }
                }
