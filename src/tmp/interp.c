...
struct cmd_type cmd_table[] =
     ...
     */
        ...
        { "stats",      do_stats,      POS_DEAD,      0, LOG_NORMAL },
     ...
     */
        ...
        { "cscore",  do_clanscore, POS_RESTING,  0, LOG_NORMAL },
...
*/
    ...
    if (!strcmp(cmd_table[cmd].name, "sing") && prime_class(ch) != CLASS_BARD)
    {
        send_to_char(C_DEFAULT, "What do you think you are, a BARD???\n\r", ch);
        return;
    }
    else if (!strcmp(cmd_table[cmd].name, "cast") && prime_class(ch) == CLASS_BARD)
    {
